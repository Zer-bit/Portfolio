...
import { fetchExperience, type ExperienceItem } from "../lib/db-data";
import { dayTheme, nightTheme } from "../lib/theme";
import { useThemeContext } from "../lib/theme-context";
import { fadeUpVariant } from "../lib/animations";
import { PixelCard } from "../components/ui/pixel-card";
import { PixelButton } from "../components/ui/pixel-button";
import { ExperienceCardSkeleton } from "../components/ui/skeleton-loader";
        ...
        <div className="flex flex-col gap-8">
          {loading
            ...
            : experienceList.map((entry, index) => {
                ...
                return (
                  <motion.div
                    key={entry.id || `${entry.company}-${entry.startDate}`}
